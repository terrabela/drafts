...
class SpecGraphics():
    ...
    def plot_figw2(self):
        ...
        self.fig_widths.add_trace(
            go.Scatter(x=self.parms.peaks_parms.xs_fwhm_lines,
                       y=self.parms.peaks_parms.ys_fwhm_lines,
                       name='FWHMs',
                       line=dict(color='blue', width=3.0)));
        self.fig_widths.add_trace(
            go.Scatter(x=self.parms.peaks_parms.xs_fwb_lines,
                       y=self.parms.peaks_parms.ys_fwb_lines,
                       name='FW at base',
                       line=dict(color='magenta', width=3.0)));
        self.fig_widths.add_trace(
            go.Scatter(x=self.parms.peaks_parms.peaks_gro,
    ...
    def plot_figw3(self):
        ...
        self.fig_is_reg.add_trace(
            go.Scatter(x=self.parms.cnt_array_like.chans_in_regs(),
        ...
        self.fig_is_reg.add_trace(
            go.Scatter(x=self.parms.cnt_array_like.chans_outof_regs(),
